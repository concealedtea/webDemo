...
<div class="page-advertiser" data-menutype="advertiser">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">
                <span class="page-operate-title">广告主信息</span>
                <ol class="breadcrumb">
    ...
    <div class="row">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="hidden" id="customerStatus" name="customerStatus" value="${advertiser.customerStatus.name}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="box-file-one w-420 parsley-box-file"><span class="box-must">·</span>
                                        <div class="box-file-base">
                                            <input  type="file" class="box-file" data-msgtip-top="点击上传营业执照图片或把图片拖拽至此处" data-msgtip-bottom="（有年检章,支持jpg/png,小于1M）" data-img-size="1024" id="certification" name="icpImageUrl" data-url="${advertiser.certification}" data-parsley-required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <c:choose>
            <c:when test="${sessionScope.USER_INFO_SESSION.inLieyingAccount}"></c:when>
            <c:otherwise>
...
<script type="text/javascript">
    $(function () {
        console.log('${sessionScope.USER_INFO_SESSION.inLieyingAccount}');
        var $pageAdvertiser = {
            init: function () {
