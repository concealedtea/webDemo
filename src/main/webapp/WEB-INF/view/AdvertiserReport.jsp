...
<div data-menutype="advertiser">
    <div class="page-index">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title pull-left">${uid} - ${uname}</h4>
...
<script type="text/javascript">
    $(function () {
        var $pageIndex = {
            ...
            init: function () {
                this.uid= $.ExtCommon.getQueryString("uid");
            ...
            bindPageData:function(){
                ...
                $.ExtAjax.initGet({
                    url: url, data: {date_type:dateType, uid:self.uid},
